...
document.querySelector("#editTransactionForm").addEventListener("submit", function(event){
    validateForm(event);
});
...
function validateForm(event){
    ...
    let type = document.forms["editTransactionForm"]["type"].value;
    let date = document.forms["editTransactionForm"]["date"].value;
    let description = document.forms["editTransactionForm"]["description"].value;
    let isValid = true;
